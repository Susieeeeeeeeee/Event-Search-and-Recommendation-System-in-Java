...
public class TicketMasterAPI {
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			...
			//below is try with resource, will auto close in
			...
			if (obj.isNull(EMBEDDED)) { // see if the value associated with key "_embedded" is null or not
				return new ArrayList<>(); // do not return null, for convenience
			}
			
			JSONObject embededJsonObject = obj.getJSONObject(EMBEDDED);
